...
const mockList = [{ address: '0x25459d928FD87271d729a98cBD13cbe2A0d093da' }];
    ...
    <div className="container">
      ...
      <List
        ...
        dataSource={
          contactList.length
            ? contactList
            : [{ address: searchKey, isAdding: true }]
        }
          ...
          isAdding ? (
            ...
            <Link to={`/m/${address}`}>
              <Tooltip arrow title={address} placement="right">
                <List.Item
                  className={location.pathname.slice(3) === address && 'active'}
                >
                  <List.Item.Meta
                    avatar={
                      <Avatar
                        size={50}
                        src={`http://xsgames.co/randomusers/assets/avatars/pixel/${
                          address % 53
                        }.jpg`}
                        shape="circle"
                      />
